...
"""autogenerated by genpy from orb_slam3_ros/ImagePose.msg. Do not edit."""
import codecs
import sys
...
class ImagePose(genpy.Message):
  _md5sum = "2c7f6f8218b81e191cb8cd626ad533fb"
  _type = "orb_slam3_ros/ImagePose"
...
float64 w
"""
  __slots__ = ['header','image','pose','tracking_success']
  _slot_types = ['std_msgs/Header','sensor_msgs/Image','geometry_msgs/Pose','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,image,pose,tracking_success
    ...
    if args or kwds:
      ...
      if self.tracking_success is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7dB().pack(_x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.tracking_success))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.tracking_success,) = _get_struct_7dB().unpack(str[start:end])
      self.tracking_success = bool(self.tracking_success)
      return self
