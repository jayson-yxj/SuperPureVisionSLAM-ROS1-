...
class Monster(nn.Module):
    def __init__(self, args):
        ...
        state_dict_dpt = torch.load(f'/home/sunteng/Desktop/HighTorque_vision/MonSter-plusplus/RT-MonSter++/checkpoints/depth_anything_v2_{args.encoder}.pth', map_location='cpu')
