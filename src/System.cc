...
Sophus::SE3f System::TrackMonocular(const cv::Mat &im, const double &timestamp, const vector<IMU::Point>& vImuMeas, string filename)
{
    ...
    cv::Mat imToFeed = im.clone();
    // cv::imshow("imToFeed", imToFeed);
    // std::cout << "img_hight: " << imToFeed.rows << ", img_width: " << imToFeed.cols << std::endl;
    ...
    // cv::imshow("NewimToFeed", imToFeed);
    // std::cout << "new img_hight: " << imToFeed.rows << ", newimg_width: " << imToFeed.cols << std::endl;
